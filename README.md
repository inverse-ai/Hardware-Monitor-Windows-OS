...
| **Drag the edge bar** | Moves it **along its edge, or across to a different edge** — it re-orients to whichever edge you drag it near; the spot is remembered |
...
**Drag the bar itself** to move it to any spot you like — slide it along its edge, or
drag it across to a **different** edge and it re-orients to match (it no longer sits
fixed in the middle / corner). The position is remembered.
